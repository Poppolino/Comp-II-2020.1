...
public class LojaTest {
    ...
    public void setUp() {
        ...
        livro1 = new Livro(12345, "Da Terra à Lua", "Julio Verne", CategoriaDeLivro.FICCAO, null, 1865);
        livro1.setPrecoEmReais(25);

        livro2 = new Livro(12446, "Dom Quixote", "Miguel de Cervantes", CategoriaDeLivro.FICCAO, null, 1605);
    ...
    private void chegadaDoEstoque() throws ItemNaoExisteNoCatalogoException, QuantidadeInconsistenteException {        
    ...
    public void testarVendaParaProdutoExistente() throws
            ...
            EnderecoInvalidoException, ErroNoPagamentoException, QuantidadeInconsistenteException {
        
        this.novoCD = new CD(121223, "Ride The Lightning", "Metaaaaallica", 1984);
        this.novoLivro1 = new Livro(12345, "Da Terra à Lua: atualizado", "Julio Verne", CategoriaDeLivro.FICCAO, "Boa editora", 1865);
        this.novoLivro2 = new Livro(12446, "Dom Quixote: o inimigo agora e outro", "Miguel de Cervantes", 
                                            CategoriaDeLivro.FICCAO, "Editora Espetacular", 1605);
    ...
    @Test
    public void testarConsultaDaQuantidadeEmEstoque() throws ItemNaoExisteNoCatalogoException, QuantidadeInconsistenteException{
        this.novoCD = new CD(121223, "Ride The Lightning", "Metaaaaallica", 1984);
        this.novoLivro1 = new Livro(12345, "Da Terra à Lua: atualizado", "Julio Verne", CategoriaDeLivro.FICCAO, "Boa editora", 1865);
        this.novoLivro2 = new Livro(12446, "Dom Quixote: o inimigo agora e outro", "Miguel de Cervantes", 
                                            CategoriaDeLivro.FICCAO, "Editora Espetacular", 1605);
    ...
    @Test
    public void testarControleDoEstoqueNosPedidos() throws
        ItemNaoExisteNoCatalogoException, EstoqueInsuficienteException, 
        EnderecoInvalidoException, ErroNoPagamentoException, QuantidadeInconsistenteException {
        ...
        try{
            ...
            fail("Uma QuantidadeInconsistenteException deveria ter sido lançada.");
        }
        catch(QuantidadeInconsistenteException e){
            // Se chegar aqui, o teste da Exceção passou
        }
        
        
        Vendavel[] listaItens= {novoCD, novoLivro1, novoLivro2, novaBicicleta};
        int[] quantItem = {80, 101, 300, 27};
        
        // Testa pedir quantidades superiores às que existem no estoque
        for(int i=0; i<quantItem.length; i++){
            try{
                assertNull(loja.receberPedido(listaItens[i], quantItem[i], comprador));
                fail("Uma EstoqueInsuficienteException deveria ter sido produzida.");
            }
    ...
    public void testarVendaParaProdutoNaoExistente() throws 
            EnderecoInvalidoException, EstoqueInsuficienteException, 
            ErroNoPagamentoException, QuantidadeInconsistenteException {
        
        String recibo = null;
        Livro livroNaoExistente = new Livro(1010101, "Blah", "Qualquer coisa", CategoriaDeLivro.LIVRO_DIDATICO,  null, 2000);
        
        try{
            recibo = loja.receberPedido(livroNaoExistente, 5, comprador);
            fail("Uma ItemNaoExisteNoCatalogoException deveria ter sido lançada.");
        } 
